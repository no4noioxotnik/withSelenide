...
#    And I want to assert that response is "correct"
        ...
        #to enter goto url ftp://localhost:2221/
    And setup ftp server set port: "2221" username: "user" password: "password" homeDir path: "src\test\resources\test_data"
    And Set timeout "50000" milliseconds
    Then stop ftp server
